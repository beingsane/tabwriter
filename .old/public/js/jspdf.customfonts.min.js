      ...
      (function (e) {
        ...
        function i(a, c, h, l) {
          ...
          var p,
            ...
            K = function () {
              return q++, (P[q] = z), Q(q + ' 0 obj'), q;
            },
            Z = function (t) {
              Q('stream'), Q(t), Q('endstream');
            },
            $ = function () {
              var t,
                n,
              ...
              for (
                ...
                if (
                  ...
                  Q('/Parent 1 0 R'),
                  Q('/Resources 2 0 R'),
                  Q('/MediaBox [0 0 ' + X(h) + ' ' + X(l) + ']'),
                  V.publish('putPage', { pageNumber: t, page: R[t] }),
                  Q('/Contents ' + (q + 1) + ' 0 R'),
                  Q('>>'),
                  Q('endobj'),
                  (n = R[t].join('\n')),
            ...
            rt = function () {
              Q('/ProcSet [/PDF /Text /ImageB /ImageC /ImageI]'), Q('/Font <<');
              for (var t in F)
                F.hasOwnProperty(t) &&
                  Q('/' + t + ' ' + F[t].objectNumber + ' 0 R');
              Q('>>'), Q('/XObject <<'), nt(), Q('>>');
            },
            it = function () {
              et(),
            ...
            ot = function () {
              ...
              (q += U.length), V.publish('postPutAdditionalObjects');
            },
            st = function (t, e, n) {
            ...
            at = function (t, e, n, r) {
              ...
              return st(i, e, n), V.publish('addFont', o), i;
            },
            ct = function (t, e) {
              ...
              if (
                ...
                (e.autoencode || s) &&
                  F[p].metadata &&
                  F[p].metadata[i] &&
                  F[p].metadata[i].encoding &&
                  ((o = F[p].metadata[i].encoding),
                  !s && F[p].encoding && (s = F[p].encoding),
            ...
            ut = function () {
              switch (
                ...
                default:
                  ...
                  '%' === t.substr(t.length - 1) && (v = parseInt(v, 10) / 100),
                    'number' == typeof v &&
                      Q('/OpenAction [3 0 R /XYZ null null ' + X(v) + ']');
              }
              ...
              y && Q('/PageMode /' + y), V.publish('putCatalog');
            },
            pt = function () {
              Q('/Size ' + (q + 1)),
                Q('/Root ' + q + ' 0 R'),
            ...
            ft = function (t, e) {
              ...
              (O = !0),
                (R[++B] = []),
                (j[B] = { width: Number(t) || m, height: Number(e) || w }),
                (D[B] = {}),
                mt(B);
            },
            dt = function () {
              ft.apply(this, arguments),
                ...
                0 !== N && Q(N + ' J'),
                0 !== L && Q(L + ' j'),
                V.publish('addPage', { pageNumber: B });
            },
            gt = function (t) {
              t > 0 &&
                t <= B &&
            ...
            wt = function (t, e) {
              var n, r;
              switch (
                ((t = void 0 !== t ? t : F[p].fontName),
                (e = void 0 !== e ? e : F[p].fontStyle),
                (r = t),
              ...
              return (
                n || (void 0 === (n = E.times[e]) && (n = E.times.normal)), n
              );
            },
            yt = function () {
              (O = !1),
              ...
              var t,
                ...
                n = '0000000000';
              for (
                Q('xref'), Q('0 ' + (q + 1)), Q(n + ' 65535 f '), t = 1;
                t <= q;
                t++
              ) {
                var r = P[t];
            ...
            St = (function (t) {
              ...
              var i =
                'dataur' === ('' + t).substr(0, 6)
                  ? 'data:application/pdf;base64,' + btoa(yt())
                  : 0;
              switch (t) {
                case void 0:
                  return yt();
          ...
          (W.internal = {
            ...
            (W.movePage = function (t, e) {
              var n, r, i, o;
              if (t > e) {
                for (n = R[t], r = j[t], i = D[t], o = t; o > e; o--)
                  (R[o] = R[o - 1]), (j[o] = j[o - 1]), (D[o] = D[o - 1]);
            ...
            (W.text = function (e, n, r, i) {
              ...
              var s,
                ...
                l = arguments[5];
              if (
                ('number' == typeof e && ((s = r), (r = n), (n = e), (e = s)),
                'string' == typeof e &&
                  (e = e.match(/[\n\r]/) ? e.split(/\r\n|\r|\n/g) : [e]),
                ('object' === (void 0 === c ? 'undefined' : t(c)) &&
                  ...
                  'number' == typeof c && ((h = c), (c = null)),
                  (i = { flags: c, angle: h, align: l })),
                h)
              ) {
                h *= Math.PI / 180;
                var u = Math.cos(h),
              ...
              var g = -1,
                ...
                y =
                  this.internal.getCurrentPageInfo().pageContext
                    .usedRenderingMode || -1;
              switch (m) {
                case 0:
                case !1:
              ...
              for (
                ...
                b.push(
                  _
                    ? k.metadata.encode(k.metadata.subset, v.shift(), A)
                    : (function (t) {
                        return (
                          (t = t
                            .split('\t')
              ...
              var O,
                ...
                B,
                R = C * T,
                D = q ? { font: k.metadata, fontSize: C, charSpace: I } : {},
                j = e.map(function (t) {
              ...
              if (l) {
                if ('left' === l) P = n;
                else if ('center' === l) (O = n - M / 2), (n -= j[0] / 2);
                else {
                  if ('right' !== l)
                    throw new Error(
                ...
                for (e = b[0], B = 1, x = b.length; B < x; B++)
                  (E = M - j[B]),
                    'center' === l && (E /= 2),
                    (e +=
                      N + 'Tj\n' + (O - P + E) + ' -' + R + ' Td ' + U + b[B]),
            ...
            (W.lines = function (t, e, n, r, i, o) {
              ...
              return o && Q(' h'), null !== i && Q(vt(i)), this;
            }),
            (W.rect = function (t, e, n, r, i) {
              vt(i);
              return (
                Q(
                  [X(t * f), X((w - e) * f), X(n * f), X(-r * f), 're'].join(
                    ' '
                  )
                ),
                null !== i && Q(vt(i)),
            ...
            (W.setFont = function (t, e) {
              return (p = wt(t, e)), this;
            }),
            (W.setFontStyle = W.setFontType = function (t) {
              return (p = wt(void 0, t)), this;
            }),
          ...
          for (var Ct in i.API)
            i.API.hasOwnProperty(Ct) &&
              ('events' === Ct && i.API.events.length
                ? (function (t, e) {
                    var n, r, i;
          ...
          return (
            (function () {
              ...
              V.publish('addFonts', { fonts: F, dictionary: E });
            })(),
            (p = 'F1'),
            dt(h, a),
          ...
          if (i.appearanceStreamContent) {
            ...
            for (var c in i.appearanceStreamContent) {
              ...
              if (
                ...
                for (var r in h)
                  'function' == typeof (l = h[r]) && (l = l.call(this, i)),
                    (s += '/' + r + ' ' + l + ' '),
  ...
  (n.internal = {}),
    ...
    (n.PDFObject.prototype.getContent = function () {
      ...
      return (t += (function (t) {
        ...
        for (var i in r) {
          ...
          s &&
            (Array.isArray(s)
              ? (e += '/' + o + ' ' + n.internal.arrayToPdfArray(s) + '\n')
        ...
        for (var v in s) {
          ...
          var x = (function (t, e, i) {
              if (t + 1 < s.length) {
                var o = e + ' ' + s[t + 1];
                return (
                  n.internal.calculateFontSpace(o, i + 'px', r).width <= h - 4
                );
              }
              return !1;
            })(b, w, a),
          ...
          if (!x || S) {
            ...
            for (var k = '', C = d; C <= g; C++) k += s[C] + ' ';
            switch (
              ((k =
                ' ' == k.substr(k.length - 1) ? k.substr(0, k.length - 1) : k),
              (m = n.internal.calculateFontSpace(k, a + 'px', r).width),
              t.Q)
            ) {
              case 2:
                p = h - m - 2;
    ...
    (e.API.addHTML = function (t, e, n, r, i) {
          ...
          if ((r.format && (u = r.format), t.height > c && r.pagesplit)) {
            var p = function () {
              for (var r = 0; ; ) {
                ...
                if ((this.addImage.apply(this, h), (r += o.height) >= t.height))
                  break;
                this.addPage();
              }
              i(l, r, null, h);
            ...
            if ('CANVAS' === t.nodeName) {
              var f = new Image();
              (f.onload = p), (f.src = t.toDataURL('image/png')), (t = f);
            } else p();
          } else {
            var d = Math.random().toString(35),
              g = [t, e, n, l, h, u, d, 'SLOW'];
            this.addImage.apply(this, g), i(l, h, d, g);
          }
        }.bind(this)),
      ...
      if ('undefined' != typeof rasterizeHTML) {
        ...
        return (
          'string' == typeof t &&
            (h = /^http/.test(t) ? 'drawURL' : 'drawHTML'),
          (r.width = r.width || a * s),
          rasterizeHTML[h](t, void 0, r).then(
            function (t) {
      ...
      (e.color_spaces = {
        ...
        (e.arrayBufferToBase64 = function (t) {
          for (
            ...
            (e =
              (258048 & (i = (a[u] << 16) | (a[u + 1] << 8) | a[u + 2])) >> 12),
              (n = (4032 & i) >> 6),
              (r = 63 & i),
          ...
          return (
            1 == h
              ? ((e = (3 & (i = a[l])) << 4),
                (o += s[(252 & i) >> 2] + s[e] + '=='))
              : 2 == h &&
                ((e = (1008 & (i = (a[l] << 8) | a[l + 1])) >> 4),
                (n = (15 & i) << 2),
                (o += s[(64512 & i) >> 10] + s[e] + s[n] + '=')),
            o
          );
        }),
        (e.createImageInfo = function (t, e, n, r, i, o, s, a, c, h, l, u, p) {
          var f = { alias: a, w: e, h: n, cs: r, bpc: i, i: s, data: t };
          return (
            o && (f.f = o),
            c && (f.dp = c),
            h && (f.trns = h),
        ...
        (e.addImage = function (e, r, i, o, m, y, v, b, x) {
          ...
          if (!(C = g(e, I))) {
            var A;
            if (
              (f(e) && (e = d(e, r, x)), h(v) && (v = l(e)), !(C = g(v, I)))
            ) {
              if (this.isString(e)) {
              ...
              if (
                ...
                !(C = this['process' + r.toUpperCase()](e, c(I), v, s(b), A)))
              )
                throw new Error(
          ...
          return w.call(this, i, o, m, y, C, C.i, I), this;
        });
      var y = function (t) {
          var e, n, r;
          if (
        ...
        v = function (t) {
          ...
          for (
            var e, n, r, i, o = t.length, s = (t[4] << 8) + t[5], a = 4;
            a < o;
          ...
          function (t) {
            for (
              ...
              switch ((h = e[i]).type) {
                case 'link':
                  if (
                    n.notEmpty(h.options.url) ||
                    n.notEmpty(h.options.pageNumber)
                  ) {
                    r = !0;
                    break;
                  }
                ...
                switch (h.type) {
                  ...
                  case 'text':
                    ...
                    (w =
                      ...
                      (d =
                        ...
                        o(h.bounds.x * s) +
                        ' ' +
                        o(a - (h.bounds.y + h.bounds.h) * s) +
                        ' ' +
                        o((h.bounds.x + h.bounds.w) * s) +
                        ' ' +
                        o((a - h.bounds.y) * s) +
                        '] ') +
                      '/Contents (' +
                  ...
                  case 'link':
                    if (h.options.name) {
                      ...
                      (h.options.pageNumber = m.page), (h.options.top = m.y);
      ...
      (t.setHeaderFunction = function (t) {
        ...
        (t.cell = function (t, e, n, r, i, o, s) {
          var l = c(),
            u = !1;
          if (void 0 !== l.ln)
            if (l.ln === o) (t = l.x + l.w), (e = l.y);
            else {
              var p = this.margins || h;
              l.y + l.h + r + 13 >= this.internal.pageSize.height - p.bottom &&
                (this.cellAddPage(),
                (u = !0),
                this.printHeaders &&
                  this.tableHeaderRow &&
        ...
        (t.table = function (e, n, r, i, a) {
          ...
          var c,
            ...
            _ = h;
          if (
            ((_.width = this.internal.pageSize.width),
            a &&
              (!0 === a.autoSize && (I = !0),
              !1 === a.printHeaders && (A = !1),
              a.fontSize && (T = a.fontSize),
              a.css &&
                void 0 !== a.css['font-size'] &&
                (T = 16 * a.css['font-size']),
              a.margins && (_ = a.margins)),
            (this.lnMod = 0),
            (o = { x: void 0, y: void 0, w: void 0, h: void 0, ln: void 0 }),
            (s = 1),
            (this.printHeaders = A),
          ...
          if (I)
            for (
              ...
              for (
                x[(c = v[l])] = r.map(y),
                  k.push(this.getTextDimensions(b[l] || c).w),
                  g = 0,
                  p = (d = x[c]).length;
                g < p;
                g += 1
              )
                (f = d[g]), k.push(this.getTextDimensions(f).w);
              (S[c] = t.arrayMax(k)), (k = []);
            }
          if (A) {
            q = this.calculateLineHeight(v, S, b.length ? b : v);
            for (l = 0, u = v.length; l < u; l += 1)
              (c = v[l]), C.push([e, n, S[c], q, String(b.length ? b[l] : c)]);
          ...
          for (l = 0, u = r.length; l < u; l += 1) {
            ...
            for (
              m = r[l],
                q = this.calculateLineHeight(v, S, m),
                g = 0,
                w = v.length;
              g < w;
              g += 1
            )
              (c = v[g]), this.cell(e, n, S[c], q, m[c], l + 2, c.align);
          }
          return (
        ...
        (t.context2d = {
          ...
          _getRGBA: function (t) {
            ...
            if (this.internal.rxTransparent.test(t))
              ...
              null != o
                ...
                : ((i = 1),
                  '#' != t.charAt(0) &&
                    ((t = CssColors.colorNameToHex(t)) || (t = '#000000')),
                  4 === t.length
                    ? ((e = t.substring(1, 2)),
                      (e += e),
                      (n = t.substring(2, 3)),
          ...
          setFont: function (t) {
            ...
            if (null != (l = e.exec(t))) {
              ...
              var h;
              (h = 'bold' === r ? 'bold' : 'normal'), this.pdf.setFont(a, h);
            } else {
              var l = (e = /\s*(\d+)(pt|px|em)\s+([\w "]+)\s*([\w "]+)?/).exec(
                t
              );
              if (null != l) {
                var u = l[1],
          ...
          _stroke: function (t) {
            if (t || !this._isStrokeTransparent()) {
              for (var e = [], n = this.path, r = 0; r < n.length; r++) {
                ...
                switch (i.type) {
                  ...
                  case 'lt':
                    ...
                    e[e.length - 1].deltas.push(u), e[e.length - 1].abs.push(i);
                    break;
                  case 'bct':
                    u = [
                      i.x1 - n[r - 1].x,
              ...
              for (r = 0; r < e.length; r++) {
                var p;
                if (((p = r == e.length - 1 ? 's' : null), e[r].arc))
                  for (var f = e[r].abs, d = 0; d < f.length; d++) {
                    var g = f[d],
                  ...
                  t
                    ? (this.pdf.lines(e[r].deltas, y, v, null, null),
                      this.pdf.clip_fixed())
                    : this.pdf.lines(e[r].deltas, y, v, null, p);
                }
              }
            }
          },
          ...
          _fill: function (t, e) {
            if (!this._isFillTransparent()) {
              ...
              if (
                (this.ctx._fillOpacity < 1 && (u = this.ctx._fillOpacity), i)
              ) {
              ...
              for (var d = this.path, g = 0; g < d.length; g++) {
                var m = d[g];
                switch (m.type) {
                  case 'mt':
                  ...
                  case 'lt':
                    ...
                    o[o.length - 1].deltas.push(k), o[o.length - 1].abs.push(m);
                    break;
                  case 'bct':
                    k = [
                      m.x1 - d[g - 1].x,
              ...
              for (g = 0; g < o.length; g++) {
                ...
                if (
                  ...
                  for (var I = o[g].abs, A = 0; A < I.length; A++) {
                    ...
                    if (void 0 !== T.startAngle) {
                      var _ = (360 * T.startAngle) / (2 * Math.PI),
                        ...
                        P = T.y;
                      if (
                        (0 === A && this.internal.move2(this, O, P),
                        this.internal.arc2(
                          this,
                          O,
                          P,
                  ...
                  var O = o[g].start.x,
                    P = o[g].start.y;
                  e
                    ? (this.pdf.lines(o[g].deltas, O, P, null, null),
                      this.pdf.clip_fixed())
                    : this.pdf.lines(o[g].deltas, O, P, null, C);
                }
              }
      ...
      Object.defineProperty(n, 'fillStyle', {
        ...
        (n.internal.arc2 = function (t, e, n, r, i, o, s, a, c) {
          var h = e,
            l = n;
          c
            ? (this.arc(t, h, l, r, i, o, s, null), this.pdf.clip_fixed())
            : this.arc(t, h, l, r, i, o, s, a);
        }),
        ...
        (m = function (t, e, n) {
          ...
          if (((r = n[t.nodeName]), !o && r))
            if ('function' == typeof r) o = r(t, e);
              ...
              for (i = 0, s = r.length; !o && i !== s; ) (o = r[i](t, e)), i++;
          for (
            a = t.className ? t.className.split(' ') : [], i = 0;
            i < a.length;
            i++
          )
            if (((r = n['.' + a[i]]), !o && r))
      ...
      (r = function (e, i, o) {
        ...
        for (
          ...
          if ('object' === (void 0 === (s = a[h]) ? 'undefined' : t(s))) {
            ...
            if (8 === s.nodeType && '#comment' === s.nodeName)
            ...
            else if (1 !== s.nodeType || S[s.nodeName])
              if (3 === s.nodeType) {
                var v = s.nodeValue;
                if (s.nodeValue && 'LI' === s.parentNode.nodeName)
                  if ('OL' === s.parentNode.parentNode.nodeName)
                    ...
                    var b = c['font-size'],
                      ...
                      I = 0.75 * b * i.pdf.internal.scaleFactor,
              ...
              if (T) {
                ...
                void 0 !== q.float && 'right' === q.float
                  ? (O += i.settings.width - s.width - E)
                  : (O += F),
                  i.pdf.addImage(T, O, i.y + B, s.width, s.height),
                  (T = void 0),
                  'right' === q.float || 'left' === q.float
                    ? (i.watchFunctions.push(
                      ...
                      (i.settings.width -= s.width + F + E),
                      'left' === q.float && (i.x += s.width + F + E))
                    : (i.y += s.height + B + R);
        ...
        (y = function (t, e, n, r) {
          ...
          for (
            var o, s = t.getElementsByTagName('img'), a = s.length, c = 0;
            a--;
              ...
              if (t) {
                ...
                (o = ++c),
                  ...
                  (s.onerror = s.onload = function () {
                    if (
                      s.complete &&
                      (0 === s.src.indexOf('data:image/') &&
                        ((s.width = n || s.width || 0),
                        (s.height = r || s.height || 0)),
                      s.width + s.height)
                    ) {
            ...
            for (
              var c = function (t) {
                  ...
                  (e.y =
                    ...
                    (e.pdf.margins_doc.bottom -= a);
                  for (
                    var c = i.getElementsByTagName('span'), h = 0;
                    h < c.length;
                    ++h
                  )
                    (' ' + c[h].className + ' ')
                      .replace(/[\n\t]/g, ' ')
                      .indexOf(' pageCounter ') > -1 && (c[h].innerHTML = o),
                      (' ' + c[h].className + ' ')
                        .replace(/[\n\t]/g, ' ')
                        .indexOf(' totalPages ') > -1 &&
                        (c[h].innerHTML = '###jsPDFVarTotalPages###');
          ...
          for (
            ...
            if (((a = t.shift()), (m = e.shift()), a))
              if (
                ...
                (h = (this.pdf.getStringUnitWidth(a, l) * l.fontSize) / p),
                '\u2028' == a)
              )
                (f = []), d.push(f);
              else if (r + h > g) {
                for (
                  c = this.pdf.splitTextToSize(a, g, l), f.push([c.shift(), m]);
                  c.length;

                )
                  (f = [[c.shift(), m]]), d.push(f);
          ...
          if (
            ...
            (a = this.splitFragmentsIntoLines(r, f)),
              ...
              'always' === e['page-break-before'] &&
                (this.pdf.addPage(),
                (this.y = 0),
                (p = ((e['margin-top'] || 0) + (e['padding-top'] || 0)) * n)),
        ...
        c = function (t, e, n, r) {
          for (
            ...
            if (((s = l * e), (i = t.subarray(s, s + e)), r))
              ...
              for (var u = 0, p = h.length, f = []; u < p; u++)
                f[u] = h[u](i, n, o);
              var d = m(f.concat());
              c.set(f[d], s + l);
            }
      ...
      t.processPNG = function (t, r, o, s, a) {
        ...
        if (
          ...
          if (
            ...
            if (8 === c.bits)
              for (
                ...
                for (I = O[k], w = 0; w < S; )
                  (b[C++] = (I >>> w) & 255), (w += c.bits);
                x[k] = (I >>> w) & 255;
              }
            if (16 === c.bits) {
              for (
                var I,
                  v = (O = new Uint32Array(c.decodePixels().buffer)).length,
                  b = new Uint8Array(v * (32 / c.pixelBitlength) * c.colors),
                  x = new Uint8Array(v * (32 / c.pixelBitlength)),
                  A = c.colors > 1,
                  k = 0,
                  C = 0,
                  T = 0;
          ...
          if (
            ...
            for (
              var _ = c.transparency.indexed, q = 0, k = 0, v = _.length;
              k < v;
              ++k
            )
              q += _[k];
            if ((q /= 255) === v - 1 && -1 !== _.indexOf(0)) l = [_.indexOf(0)];
              ...
              for (
                var O = c.decodePixels(),
                  x = new Uint8Array(O.length),
                  k = 0,
                  v = O.length;
                k < v;
                k++
    ...
    (function (t) {
      var e = (t.getCharWidthsArray = function (t, e) {
          e || (e = {});
          var n,
            r = 0 !== Object.keys(this.internal.getFont().metadata).length,
            i = t.length,
            o = [];
          if (this.internal.getFont().id.slice(1) >= 14 && r) {
            ...
            for (n = 0; n < i; n++)
              o.push(
                this.internal.getFont().metadata.widthOfString(t[n], s, a) / s
              );
          } else {
            var c = e.widths
                ? e.widths
        ...
        o = function (t, o, s) {
          ...
          for (h = 0, l = v.length; h < l; h++) {
            ...
            if (
              ...
              if (y > o) {
                for (
                  u = i(a, c, o - (m + w), o), d.push(u.shift()), d = [u.pop()];
                  u.length;
      ...
      t.splitTextToSize = function (t, e, n) {
        ...
        for (c = 0, h = r.length; c < h; c++)
          l = l.concat(o.call(this, r[c], a, s));
        return l;
      };
    })(
      e.API
...
*/,
          ...
          for (n = 1; n != f; )
            (s = t[n]),
              ...
              "'" == s
                ...
                ? r.push(s)
                : '{' == s
                ? (l.push([h, o]), (h = {}), (o = void 0))
                : '}' == s
                ? (((i = l.pop())[0][i[1]] = h), (o = void 0), (h = i[0]))
                : '-' == s
                ? (c = -1)
                : void 0 === o
                ? e.hasOwnProperty(s)
                  ? ((u += e[s]), (o = parseInt(u, 16) * c), (c = 1), (u = ''))
                  : (u += s)
                : e.hasOwnProperty(s)
                ? ((p += e[s]),
                  (h[o] = parseInt(p, 16) * c),
          ...
          (((f = (function (t) {
            for (
              ...
              'c' === t[i]
                ...
                : (i += 1);
            return [e, n, r];
          })(p.getAttribute('d').split(' ')))[0] = f[0] * a[0] + e),
          (f[1] = f[1] * a[1] + n),
          this.lines.call(this, f[2], f[0], f[1], a));
      return this;
    }),
    ...
    (e.API.viewerPreferences = function (e, n) {
      ...
      if (
        ...
        var d = c.length;
        for (p = 0; p < d; p += 1)
          (i[c[p]].value = i[c[p]].defaultValue), (i[c[p]].explicitSet = !1);
      }
      if ('object' === (void 0 === e ? 'undefined' : t(e)))
        for (o in e)
          if (((s = e[o]), r(c, o) && void 0 !== s)) {
            if ('boolean' === i[o].type && 'boolean' == typeof s)
              i[o].value = s;
            else if ('name' === i[o].type && r(i[o].valueSet, s))
              i[o].value = s;
            else if ('integer' === i[o].type && Number.isInteger(s))
              i[o].value = s;
            else if ('array' === i[o].type) {
              for (l = 0; l < s.length; l += 1)
                if (((f = !0), 1 === s[l].length && 'number' == typeof s[l][0]))
                  h.push(String(s[l]));
                else if (s[l].length > 1) {
                  for (u = 0; u < s[l].length; u += 1)
                    'number' != typeof s[l][u] && (f = !1);
                  !0 === f && h.push(String(s[l].join('-')));
                }
              i[o].value = String(h);
    ...
    (function (t) {
      var e = (function () {
          ...
          (t.open = function (n, r, i, o) {
            ...
            (t.prototype.characterToGlyph = function (t) {
              var e;
              return (
                (void 0 !== (e = this.cmap.unicode) ? e.codeMap[t] : void 0) ||
                0
              );
            }),
            ...
            (t.prototype.embedTTF = function (t, e, n) {
              function r(t) {
                ...
                return (
                  'Font' === t.Type
                    ? (g && (t.ToUnicode = r(t.ToUnicode) + ' 0 R'),
                      (t.FontDescriptor = r(t.FontDescriptor) + ' 0 R'),
                      (i = e()),
                      n(I.convert(t)))
                    : 'FontDescriptor' === t.Type
                    ? ((t.FontFile2 = r(t.FontFile2) + ' 0 R'),
                      (i = e()),
                      n(I.convert(t)))
                    : ((i = e()),
                      n('<</Length1 ' + t.length + '>>'),
                      n('stream'),
                      n(
                        Array.isArray(t) || t.constructor === Uint8Array
                          ? o(t)
                          : t
                      ),
                      n('endstream')),
              ...
              var i,
                ...
                f,
                d,
                g = 'MacRomanEncoding' === t;
              return (
                (l = this.subset.encode()),
                (f = {}),
                (f = g ? l : this.rawData),
                (u = {
                  Type: 'FontDescriptor',
                ...
                (33 == (p = +Object.keys(this.subset.cmap)[0]) || !g) &&
                  ((i = function () {
                    var t, e;
                    (t = this.subset.cmap), (e = []);
                    for (c in t)
                      Object.prototype.hasOwnProperty.call(t, c) &&
                        ((d = t[c]), e.push(Math.round(this.widthOfGlyph(d))));
                    return e;
                  }.call(this)),
                  (a = h(this.subset.subset)),
                  r(
                    g
                      ? {
                          Type: 'Font',
          ...
          var e = function (t) {
              ...
              return (
                2 === a
                  ? e(
                      255 &
                        (s = (i(t.charAt(n)) << 2) | (i(t.charAt(n + 1)) >> 4))
                    )
                  : 1 === a &&
                    (e(
                      ((s =
        ...
        r = (function () {
          ...
          return (
            ...
            (e = function (t) {
              ...
              for (r = new n(t), e = 0, o = 0, s = t.length; o < s; o += 4)
                e += r.readUInt32();
              return 4294967295 & e;
            }),
            t
              ...
              switch (
                ...
                case 'macroman':
                  ...
                  return (
                    ...
                    O.writeUInt16(0),
                    O.write(m),
                    { charMap: o, subtable: O.data, maxGlyphID: g + 1 }
                  );
                case 'unicode':
                  for (
                    _ = [], u = [], v = 0, y = {}, r = {}, F = 0, D = s.length;
                    F < D;
                    F++
                  )
                    void 0 === y[(x = t[(i = s[F])])] && (y[x] = ++v),
                      (r[i] = { old: x, new: y[x] }),
                      (a = y[x] - i),
                      (void 0 !== w && a === h) ||
                        (w && u.push(w), _.push(i), (h = a)),
                      (w = i);
                  for (
                    w && u.push(w),
                      u.push(65535),
                      _.push(65535),
                      A = 2 * (I = _.length),
                      C = 2 * Math.pow(Math.log(I) / Math.LN2, 2),
                      p = Math.log(C / 2) / Math.LN2,
                      k = 2 * I - C,
                      c = [],
                      S = [],
                      f = [],
                    ...
                    if (((q = r[T].new), T - q >= 32768))
                      for (
                        c.push(0), S.push(2 * (f.length + I - d)), i = B = T;
                        T <= l ? B <= l : B >= l;
                        i = T <= l ? ++B : --B
                      )
                        f.push(r[i].new);
                    else c.push(q - T), S.push(0);
                  }
                  for (
                    O.writeUInt16(3),
                      O.writeUInt16(1),
                      O.writeUInt32(12),
                      O.writeUInt16(4),
                      O.writeUInt16(16 + 8 * I + 2 * f.length),
                      O.writeUInt16(0),
                      O.writeUInt16(A),
                      O.writeUInt16(C),
                      O.writeUInt16(p),
                    ...
                    (i = u[H]), O.writeUInt16(i);
                  for (O.writeUInt16(0), W = 0, U = _.length; W < U; W++)
                    (i = _[W]), O.writeUInt16(i);
                  for (G = 0, N = c.length; G < N; G++)
                    (a = c[G]), O.writeUInt16(a);
                  for (X = 0, L = S.length; X < L; X++)
                    (b = S[X]), O.writeUInt16(b);
                  for (Y = 0, z = f.length; Y < z; Y++)
                    (g = f[Y]), O.writeUInt16(g);
                  return { charMap: r, subtable: O.data, maxGlyphID: v + 1 };
              }
            }),
            t
          );
        ...
        l = (function (t) {
          ...
          return (
            ...
            (e.prototype.encode = function (t) {
              ...
              for (
                (e = new n()).writeInt(this.version),
                  e.writeShort(this.ascender),
                  e.writeShort(this.decender),
                  e.writeShort(this.lineGap),
                  e.writeShort(this.advanceWidthMax),
                  e.writeShort(this.minLeftSideBearing),
                  e.writeShort(this.minRightSideBearing),
                  e.writeShort(this.xMaxExtent),
                  e.writeShort(this.caretSlopeRise),
                  e.writeShort(this.caretSlopeRun),
                  e.writeShort(this.caretOffset),
                  r = 0,
                  8;
                r < 8;
                ++r
                ...
                e.writeByte(0);
              return (
                e.writeShort(this.metricDataFormat),
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.prototype.glyphFor = function (t) {
              ...
              switch (this.format) {
                case 65536:
                  return r[t] || '.notdef';
                case 131072:
                  return (e = this.glyphNameIndex[t]) <= 257
                    ? r[e]
                    : this.names[e - 258] || '.notdef';
                case 151552:
            ...
            (e.prototype.encode = function (t) {
              ...
              for (
                (u = new n(c.slice(0, 32))).writeUInt32(131072),
                  u.pos = 32,
                  o = [],
                  l = [],
                  p = 0,
                ...
                (e = t[p]),
                  ...
                  -1 !== (s = r.indexOf(a))
                    ? o.push(s)
                    : (o.push(257 + l.length), l.push(a));
              for (
                u.writeUInt16(Object.keys(t).length), f = 0, m = o.length;
                f < m;
                f++
              )
                (i = o[f]), u.writeUInt16(i);
              for (d = 0, w = l.length; d < w; d++)
                (h = l[d]), u.writeByte(h.length), u.writeString(h);
              return u.data;
            }),
        ...
        d = (function (t) {
          ...
          return (
            ...
            (e.prototype.parse = function (t) {
              ...
              for (a = {}, i = l = 0, u = n.length; l < u; i = ++l)
                (r = n[i]),
                  (t.pos = r.offset),
                ...
                if (
                  ...
                  for (p = 0, d = e.length; p < d; p++)
                    (c = e[p]),
                      ...
                      l.writeShort(a.pos),
                      a.writeString(c.raw);
              return { postscriptName: o.raw, table: l.data.concat(a.data) };
            }),
            e
          );
        })(),
        g = function (t) {
          ...
          for (
            a = (e = 'abcdefghijklmnopqrstuvwxyz').length, h = t, r = t.length;
            r >= 0;

          ) {
            if (((s = t.charAt(--r)), isNaN(s))) {
              if (-1 === (i = e.indexOf(s.toLowerCase()))) (c = s), (n = !0);
              else if (
                ((c = e.charAt((i + 1) % a)),
                (o = s === s.toUpperCase()) && (c = c.toUpperCase()),
                (n = i + 1 >= a) && 0 === r)
              ) {
                h = (o ? 'A' : 'a') + c + h.slice(1);
                break;
        ...
        w = (function (t) {
          ...
          return (
            ...
            (e.prototype.encode = function (t) {
              var e, r, i, o, s;
              for (i = new n(), o = 0, s = t.length; o < s; o++)
                (e = t[o]),
                  (r = this.forGlyph(e)),
            ...
            (e.prototype.glyphFor = function (t) {
              ...
              return t in this.cache
                ...
                : ((o = this.file.loca),
                  ...
                  (r = o.indexOf(t)),
                  0 === (i = o.lengthOf(t))
                    ? ((this.cache[t] = null), this.cache[t])
                    : ((e.pos = this.offset + r),
                      (a = new n(e.read(i))),
                      (s = a.readShort()),
                      (h = a.readShort()),
        ...
        b = (function () {
          ...
          return (
            ...
            (t.prototype.encode = function (t) {
              var e, r, o, s, a, c;
              for (
                o = new n(i.call(this.raw.data)),
                  e = s = 0,
                  a = (c = this.glyphIDs).length;
                s < a;
                e = ++s
              )
                (r = c[e]), (o.pos = this.glyphOffsets[e]), o.writeShort(t[r]);
              return o.data;
            }),
            t
          );
        ...
        x = (function (t) {
          ...
          return (
            ...
            (e.prototype.parse = function (t) {
              ...
              return (
                (t.pos = this.offset),
                0 === this.file.head.indexToLocFormat
                  ? ((this.offsets = function () {
                      var n, r, i;
                      for (
                        i = [], e = n = 0, r = this.length;
                        n < r;
                        e = n += 2
                      )
            ...
            (e.prototype.encode = function (t) {
              ...
              for (r = new n(), i = 0, a = t.length; i < a; i++)
                if (t[i] > 65535) {
                  for (o = 0, c = (l = this.offsets).length; o < c; o++)
                    (e = l[o]), r.writeUInt32(e);
                  return { format: 1, table: r.data };
                }
              for (s = 0, h = t.length; s < h; s++)
                (e = t[s]), r.writeUInt16(e / 2);
              return { format: 0, table: r.data };
            }),
            e
          );
        })(),
                ...
                return (
                  ...
                  (function () {
                    ...
                    for (o = [], e = 0, i = n.length; e < i; e++)
                      (r = n[e]), o.push(t.convert(r));
                    return o;
                  })().join(' ') +
                  ']'
                );
              if ('string' == typeof n)
                return -1 === n.indexOf(' 0 R') ? '/' + n : n;
      ...
      t.events.push([
        'addFont',
        function (n) {
          t.existsFileInVFS(n.postScriptName)
            ? ((n.metadata = e.open(
                n.postScriptName,
                n.fontName,
                t.getFileFromVFS(n.postScriptName),
                n.encoding
              )),
              (n.encoding =
                n.metadata.hmtx.widths.length < 500 &&
                n.metadata.capHeight < 800
                  ? 'WinAnsiEncoding'
                  : 'MacRomanEncoding'))
            : n.id.slice(1) >= 14 &&
              console.error(
          ...
          return (
            ...
            (i.append = function (t) {
              ...
              if (w && (t instanceof m || t instanceof w)) {
                for (var i = '', o = new w(t), c = 0, h = o.length; c < h; c++)
                ...
                !(function (r) {
                  ...
                  function f(t) {
                    var e,
                      ...
                      C = [];
                    for (
                      m = (t = a(t)).length, e = A, n = 0, s = I, c = 0;
                      c < m;
                      ++c
                    )
                    ...
                    (u.contentWindow.onload = u.onload = function () {
                      var t = setInterval(function () {
                        n.body.childNodes.length > 0 &&
                          ...
                          clearInterval(t),
                          'view' === a.type &&
                            (u.contentWindow.scrollTo(c, h),
                            !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                              (u.contentWindow.scrollY === h &&
                                u.contentWindow.scrollX === c) ||
          ...
          4: [
            function (t, e, n) {
              function r(t, e) {
                ...
                if (
                  ((e = e || {}).logging &&
                    ((m.options.logging = !0), (m.options.start = Date.now())),
                  ...
                  (e.renderer =
                    'function' == typeof e.renderer ? e.renderer : p),
                  (e.strict = !!e.strict),
                  'string' == typeof t)
                ) {
              ...
              function i(t, e, n, r, i) {
                return y(
                  ...
                  return ('function' == typeof e.onclone
                    ? Promise.resolve(e.onclone(h.document))
                    : Promise.resolve(!0)
                  ).then(function () {
                    return o(l, s, e, n, r);
                  });
              ...
              function s(t, e) {
                e.removeContainer &&
                  (t.parentNode.removeChild(t), m('Cleaned up container'));
              }
              function a(t, e) {
            ...
            function (t, e, n) {
              ...
              (r.prototype.cloneTo = function (t) {
                ...
                (r.prototype.color = function (t) {
                  return (
                    this.colors[t] || (this.colors[t] = new h(this.css(t)))
                  );
                }),
            ...
            function (t, e, n) {
              ...
              function h(t, e, n) {
                ...
                return {
                  ...
                  topRightOuter: c(r + m, i, l, u).topRight.subdivide(0.5),
                  topRightInner: c(
                    r + Math.min(m, o + n[3].width),
                    i + n[0].width,
                    m > o + n[3].width ? 0 : l - n[3].width,
                    u - n[0].width
                  ).topRight.subdivide(0.5),
                  bottomRightOuter: c(r + y, i + w, p, f).bottomRight.subdivide(
                    0.5
                  ),
                  bottomRightInner: c(
                  ...
                  bottomLeftOuter: c(r, i + v, d, g).bottomLeft.subdivide(0.5),
                  bottomLeftInner: c(
                    r + n[3].width,
                    i + v,
              ...
              function b(t) {
                return ['TopLeft', 'TopRight', 'BottomRight', 'BottomLeft'].map(
                  function (e) {
                    ...
                    return n.length <= 1 && (n[1] = n[0]), n.map(F);
                  }
                );
              }
              function x(t) {
              ...
              function j(t) {
                for (var e, n = [], r = 0, i = !1; t.length; )
                  M(t[r]) === i
                    ? ((e = t.splice(0, r)).length && n.push(L.ucs2.encode(e)),
                      (i = !i),
                      (r = 0))
                    : r++,
                    r >= t.length &&
                      (e = t.splice(0, r)).length &&
                      n.push(L.ucs2.encode(e));
                return n;
              }
              function M(t) {
              ...
              (r.prototype.calculateOverflowClips = function () {
                this.nodes.forEach(function (t) {
                  if (T(t)) {
                    _(t) && t.appendToDOM(), (t.borders = this.parseBorders(t));
                    var e =
                ...
                (r.prototype.getPseudoElement = function (t, e) {
                  ...
                  if (
                    ...
                    return (s.src = K(r)[0].args[0]), [a];
                  var l = document.createTextNode(r);
                  return s.appendChild(l), [a, new H(l, a)];
                }),
                ...
                (r.prototype.paint = function (t) {
                  try {
                    t instanceof s
                      ...
                      : q(t)
                      ? (_(t.parent) && t.parent.appendToDOM(),
                        this.paintText(t),
                        _(t.parent) && t.parent.cleanDOM())
                      : this.paintNode(t);
                  } catch (t) {
                        ...
                        switch (t.node.nodeName) {
                          ...
                          case 'IMG':
                            ...
                            r
                              ...
                              : N('Error loading <img>', t.node.src);
                            break;
                          case 'CANVAS':
                ...
                (r.prototype.paintText = function (t) {
                  ...
                  var e = L.ucs2.decode(t.node.data),
                    n =
                      (this.options.letterRendering && !v(t)) || U(t.node.data)
                        ? e.map(function (t) {
                    ...
                    t.split('').forEach(function (t) {
                      if (!(0 === h && ' \r\n\t'.indexOf(t) > -1)) {
                        switch (t) {
                          ...
                          case '(':
                            if (s) break;
                            if (0 === h) return (h = 1), void (o += t);
                            l++;
                            break;
                          case ')':
                            if (s) break;
                            if (1 === h) {
                              if (0 === l) return (h = 0), (o += t), void u();
                              l--;
                            }
                            break;
                          case ',':
      ...
      (e = (function () {
        ...
        return (
          ...
          (e.prototype.decodeFrames = function (t) {
            ...
            if (this.animation) {
              for (
                h = [], r = s = 0, a = (c = this.animation.frames).length;
                s < a;
                r = ++s
              )
                (e = c[r]),
    ...
    o = (function () {
      ...
      function e(e) {
        var n = 0,
          r = e[n++],
          o = e[n++];
        (-1 != r && -1 != o) || t('Invalid header in flate stream'),
        ...
        return (
          ...
          (e.prototype.getCode = function (e) {
            ...
            var h = n[o & ((1 << r) - 1)],
              ...
              u = 65535 & h;
            return (
              (0 == i || i < l || 0 == l) && t('Bad encoding in flate stream'),
              (this.codeBuf = o >> l),
              (this.codeSize = i - l),
              (this.bytesPos = a),
              u
          ...
          (e.prototype.generateHuffmanTable = function (t) {
            ...
            for (
              ...
              for (var h = 0; h < e; ++h)
                if (t[h] == s) {
                  for (var l = 0, u = a, r = 0; r < s; ++r)
                    (l = (l << 1) | (1 & u)), (u >>= 1);
                  for (r = l; r < i; r += c) o[r] = (s << 16) | h;
                  ++a;
                }
            return [o, n];
          }),
          (e.prototype.readBlock = function () {
            ...
            if ((1 & i && (this.eof = !0), 0 != (i >>= 1))) {
              ...
              for (
                var b = (F = this.buffer) ? F.length : 0, x = this.bufferLength;
                ;

              ) {
                var S = this.getCode(c);
                if (S < 256)
                  x + 1 >= b && (b = (F = this.ensureBuffer(x + 1)).length),
                    (F[x++] = S);
                else {
        ...
        (t.btoa = function (t) {
          ...
          do {
            (n =
              ...
              (i = (s >> 6) & 63),
              (o = 63 & s),
              (l[c++] = e.charAt(n) + e.charAt(r) + e.charAt(i) + e.charAt(o));
          } while (a < t.length);
          h = l.join('');
          var u = t.length % 3;
